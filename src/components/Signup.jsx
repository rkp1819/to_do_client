...
export default function Signup() {
  ...
  function prepareRegisterData() {
    // registerData.username = registerData.firstName+" "+registerData.lastName;
  ...
  function register() {
    ...
    axios
      ...
      .then((response) => {
        console.log("response from post /register route" + response);
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControlLabel
                ...
                label="I want to be an Admin user, so that I can see the taskboard of all users."
              />
            </Grid>{" "}
            <Grid item xs={12}>
              <FormControlLabel
